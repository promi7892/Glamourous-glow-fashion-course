			...
			<div className='container my-5 testimonial g-4'>
				<div className='lg-12'>
					<Card className='h-100 m-3'>
						<Card.Img className='test-img' variant='top' src={image3} />
						<Card.Body>
				...
				<div>
					<Card className='h-100 m-3'>
						<Card.Img variant='top' src={image1} className='test-img' />
						<Card.Body>
							<Card.Title className='text-center my-3'>
				...
				<div>
					<Card className='h-100 m-3'>
						<Card.Img className='test-img' variant='top' src={image2} />
						<Card.Body>
							<Card.Title className='text-center my-3'>
								Alexander B.
